...
SHAKE_RISE = 10
SHAKE_FALL = 12
SHAKE_PERIOD = 4.5              # tick/周期，越小抖得越快
SHAKE_BASE = 0.75
SHAKE_START = 0.50
SHAKE_INIT = 0.50
SHAKE_DECAY = 0.0130
SHAKE_RECOVER = 0.00012
SHAKE_CF_COLD = 3.00            # 冷度满时的权重倍率
...
SNIFF_INIT = 0.45
SNIFF_DECAY = 0.0065
SNIFF_RECOVER = 0.00010

# 靠墙：走到最近的墙边斜倚一会，用图集里闲置的 LegsAWall 帧
LEAN_WALK_TIMEOUT = 320         # 走不到就放弃，别卡死在路上
LEAN_HOLD_MIN = 260
LEAN_HOLD_MAX = 620
LEAN_RISE = 40
LEAN_FALL = 35
LEAN_ARRIVE_EPS = 8.0
LEAN_MAX_WALK = 420.0           # 墙太远就不专程跑一趟
LEAN_BASE = 0.90
LEAN_START = 0.60
LEAN_INIT = 0.25
LEAN_DECAY = 0.0020
LEAN_RECOVER = 0.00008
LEAN_SF_FRESH = 0.70
LEAN_SF_TIRED = 1.60
